...
public class HttpUtil {
    ...
    static {
        ...
        try {
            ...
            logger.error("HttpClientUtil init error", e);
     ...
     * @return
     */
    private static byte[] sendHttpGetWithBytes(HttpGet httpGet) {
        ...
        try {
            ...
            logger.error("HttpClientUtil sendHttpGetWithBytes error", e);
        } finally {
            release(response);
        }
    ...
    public static String sendHttpGet(String httpUrl, Map<String, String> maps) {
        ...
        if (StringUtils.isNotBlank(parem)) {
            httpUrl += "?" + parem;
        }
        // 创建get请求
        HttpGet httpGet = new HttpGet(httpUrl);
     ...
     * @param httpUrl
     */
    public static byte[] sendHttpGetWithBytes(String httpUrl) {
        // 创建get请求
        HttpGet httpGet = new HttpGet(httpUrl);
        return sendHttpGetWithBytes(httpGet);
    }
    ...
    public static String sendHttpPostJson(String httpUrl, String paramsJson) {
        ...
        try {
            ...
            logger.error("HttpClientUtil sendHttpPostJson error", e);
        }
        return sendHttpPost(httpPost);
    }
    ...
    public static String sendHttpPostXml(String httpUrl, String paramsXml) {
        ...
        try {
            ...
            logger.error("HttpClientUtil sendHttpPostXml error", e);
        }
        return sendHttpPost(httpPost);
    }
